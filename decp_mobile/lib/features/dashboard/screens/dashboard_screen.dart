  ...
  Widget _buildQuickActionCard(IconData icon, String title) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFFE2E8F0), style: BorderStyle.none), // Wait, web uses dashed/solid light border
      ),
      // Actually web uses dashed border. Let's use a solid light border for mobile simplicity.
      child: Container(
        decoration: BoxDecoration(
           borderRadius: BorderRadius.circular(16),
